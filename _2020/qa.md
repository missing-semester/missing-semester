...
- [Vimium](https://github.com/philc/vimium) - When programming intensively, frequently using browser to search on stack overflow etc. is common. Vimium allow us to use vim-like key binding so that you can use keyboard when searching and surfing on browser.
