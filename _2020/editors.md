...
- Example: convert xml to json ([file](/_2020/files/example-data.xml))
...
1. Complete `vimtutor`. Note: it looks best in a
   ...
   terminal window.
1. Download our [basic vimrc](/_2020/files/vimrc) and save it to `~/.vimrc`. Read
...
1. (Advanced) Convert XML to JSON ([example file](/_2020/files/example-data.xml))
