...
The specific list of versions can be then saved to a file for reproducibility purposes, this files are referred to as _lock files_.
...
Docker Compose is a tool for defining and running multi-container applications. Rather than managing containers individually, you declare all services in a single YAML file and orchestrate them together. Now our full application encompasses more than one container and we can use orchestration solutions like docker compose:
