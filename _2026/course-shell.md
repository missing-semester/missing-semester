...
Some commands are provided by the shell itself as builtins. For other
commands, the shell consults an _environment variable_ called `$PATH`
that lists which directories it should search for programs:
